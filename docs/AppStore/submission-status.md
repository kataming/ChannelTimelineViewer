...
| スクリーンショット | **日本語・英語・中国語・スペイン語・ドイツ語・フランス語は6枚**（ホーム/一覧/フィルター/**再生画面**/進捗/このアプリについて）。**韓国語は5枚**（再生画面のみ未登録）。素材は権利関係の安全な NASA 公式チャンネル（米政府の著作物＝パブリックドメイン） | App Store Screenshots ワークフロー |
...
| 項目 | 誰が | 内容 |
| --- | --- | --- |
| 韓国語の再生画面スクショ | ユーザー | いただいた画像が 739×1600 と小さく、6.9インチ枠(1320×2868)に拡大するとぼやけるため未登録。**縮小せずそのままの実機スクショ**をもらえれば登録できる（無くても提出は可能） |
