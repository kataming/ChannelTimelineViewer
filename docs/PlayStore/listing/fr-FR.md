# Google Play ストア掲載情報 — Français (France)（fr-FR）
...
Vous pouvez changer de chaîne gratuitement, mais l’historique, la progression et les notes de la précédente sont alors effacés.
