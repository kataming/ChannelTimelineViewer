...
IOS_STEPS = {
    ...
    # ⚠️ 上端のステータスバー（時計・電波・電池）は必ず落とす。
    #    中途半端に残ると見苦しく、撮った端末の情報も写る。
    5: dict(crop=None, ratio=(0.055, 0.62), box=None),
}
...
ANDROID_STEPS = {
    ...
    #    ⚠️ 実機のステータスバー（通信会社名・時刻・電池）は必ず落とす。
    #       残ると撮った人の端末の情報が説明画像に写り込む。
    5: dict(crop=(0.035, 0.62), box=None),
}
