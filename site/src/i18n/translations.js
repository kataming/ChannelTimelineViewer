...
const en = {
  ...
  features: [
    ...
    { title: 'Repeat and autoplay', body: 'Repeat one video or the whole list. Autoplay to the next video is on by default and can be turned off at any time.' },
  ...
  store: {
    ...
    androidNote: 'The Android version is also available on Google Play.',
...
const ja = {
  ...
  features: [
    ...
    { title: 'リピートと自動再生', body: '1本リピート／全体リピートに対応。次の動画への自動再生は初期状態でオンで、いつでもオフにできます。' },
  ...
  store: {
    ...
    androidName: 'Google Play',
    androidStatus: '審査中',
    androidNote: 'Android 版も Google Play で公開中です。',
...
const zh = {
  ...
  features: [
    ...
    { title: '重复与自动播放', body: '支持单个重复与整个列表重复。自动播放下一个视频默认开启，可随时关闭。' },
  ...
  store: {
    ...
    androidName: 'Google Play',
    androidStatus: '审核中',
    androidNote: 'Android 版也已在 Google Play 上线。',
...
const es = {
  ...
  features: [
    ...
    { title: 'Repetir y autoplay', body: 'Repite un vídeo o toda la lista. La reproducción automática está activada por defecto y puedes desactivarla cuando quieras.' },
  ...
  store: {
    ...
    iosName: 'App Store',
    androidPre: 'Disponible en',
    androidName: 'Google Play',
    androidStatus: 'En revisión',
    androidNote: 'La versión para Android también está disponible en Google Play.',
...
const de = {
  ...
  features: [
    ...
    { title: 'Wiederholen und Autoplay', body: 'Ein Video oder die ganze Liste wiederholen. Autoplay zum nächsten Video ist standardmäßig an und jederzeit abschaltbar.' },
  ...
  store: {
    iosPre: 'Laden im',
    iosName: 'App Store',
    androidPre: 'Jetzt bei',
    androidName: 'Google Play',
    androidStatus: 'In Prüfung',
    androidNote: 'Die Android-Version ist ebenfalls bei Google Play erhältlich.',
...
const fr = {
  ...
  features: [
    ...
    { title: 'Répétition et lecture auto', body: 'Répétez une vidéo ou toute la liste. La lecture automatique est activée par défaut et peut être désactivée à tout moment.' },
  ...
  store: {
    ...
    iosName: 'App Store',
    androidPre: 'Disponible sur',
    androidName: 'Google Play',
    androidStatus: 'En cours d’examen',
    androidNote: 'La version Android est également disponible sur Google Play.',
...
const ko = {
  ...
  features: [
    ...
    { title: '반복과 자동 재생', body: '한 편 반복과 전체 반복을 지원합니다. 다음 동영상 자동 재생은 기본으로 켜져 있으며 언제든지 끌 수 있습니다.' },
  ...
  store: {
    ...
    androidName: 'Google Play',
    androidStatus: '심사 중',
    androidNote: 'Android 버전도 Google Play에서 이용하실 수 있습니다.',
